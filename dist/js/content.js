...
class Filter {
    ...
    checkfeeRange(fee) {
        ...
        else if (_setting_Settings__WEBPACK_IMPORTED_MODULE_3__.settings.feeRange === '<=') {
            return fee <= _setting_Settings__WEBPACK_IMPORTED_MODULE_3__.settings.fee;
        }
        else {
            return fee === _setting_Settings__WEBPACK_IMPORTED_MODULE_3__.settings.fee;
...
/* harmony import */ var _download_SaveFanCard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./download/SaveFanCard */ "./src/ts/download/SaveFanCard.ts");
...
class InitHomePage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_3__.InitPageBase {
    ...
    addCrawlBtns() {
        ...
        if (_PageType__WEBPACK_IMPORTED_MODULE_7__.pageType.type === _PageType__WEBPACK_IMPORTED_MODULE_7__.pageType.list.Home ||
            _PageType__WEBPACK_IMPORTED_MODULE_7__.pageType.type === _PageType__WEBPACK_IMPORTED_MODULE_7__.pageType.list.Supporting) {
            _Tools__WEBPACK_IMPORTED_MODULE_2__.Tools.addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__.Colors.bgGreen, '_保存所有粉丝卡').addEventListener('click', () => {
                _download_SaveFanCard__WEBPACK_IMPORTED_MODULE_8__.saveFanCard.save('all');
            });
        }
        if (_PageType__WEBPACK_IMPORTED_MODULE_7__.pageType.type === _PageType__WEBPACK_IMPORTED_MODULE_7__.pageType.list.Home) {
...
/* harmony import */ var _download_SaveFanCard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./download/SaveFanCard */ "./src/ts/download/SaveFanCard.ts");
...
class InitPostListPage extends _InitPageBase__WEBPACK_IMPORTED_MODULE_3__.InitPageBase {
    ...
    addCrawlBtns() {
        ...
        // 添加保存粉丝卡的按钮
        _Tools__WEBPACK_IMPORTED_MODULE_2__.Tools.addBtn('crawlBtns', _Colors__WEBPACK_IMPORTED_MODULE_1__.Colors.bgGreen, '_保存该用户的粉丝卡').addEventListener('click', () => {
            _download_SaveFanCard__WEBPACK_IMPORTED_MODULE_6__.saveFanCard.save('current');
        });
        // 虽然可以判断是否赞助了这个用户：
...
class ShowHowToUse {
    ...
    check() {
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_4__.settings.showHowToUse) {
            this.show();
            (0,_setting_Settings__WEBPACK_IMPORTED_MODULE_4__.setSetting)('showHowToUse', false);
        }
    }
    show() {
        ...
        if (_setting_Settings__WEBPACK_IMPORTED_MODULE_8__.settings.totalDownloadLimitSwitch) {
            ...
            if (total > _setting_Settings__WEBPACK_IMPORTED_MODULE_8__.settings.totalDownloadLimitByte) {
                ...
                const msg = _Lang__WEBPACK_IMPORTED_MODULE_4__.lang.transl('_下载已暂停原因') +
                    '<br>' +
                    _Lang__WEBPACK_IMPORTED_MODULE_4__.lang.transl('_每天下载的文件大小限制');
...
class Resume {
    ...
    async saveData() {
        ...
        // 保存本次任务的数据
        _Log__WEBPACK_IMPORTED_MODULE_1__.log.log(_Lang__WEBPACK_IMPORTED_MODULE_2__.lang.transl('_正在保存抓取结果'));
        const resultData = {
            id: this.taskId,
            url: url,
...
class SaveFanCard {
    ...
    async save(scope) {
        ...
        this.busy = true;
        this.displayName = window.confirm(_Lang__WEBPACK_IMPORTED_MODULE_1__.lang.transl('_你想在粉丝卡上显示你的用户名吗'));
        this.loadMaskURL();
        let createIds = [];
        if (scope === 'all') {
            ...
            const createId = _API__WEBPACK_IMPORTED_MODULE_0__.API.getCreatorId(window.location.href);
        ...
        for (const createId of createIds) {
            ...
            if (data) {
                if (!data.backgroundURL) {
                    _Lang__WEBPACK_IMPORTED_MODULE_1__.lang.transl('_没有获取到背景图片的URL');
                }
        ...
        if (this.errorCount < total) {
            const msg = _Lang__WEBPACK_IMPORTED_MODULE_1__.lang.transl('_粉丝卡保存完毕');
            _Log__WEBPACK_IMPORTED_MODULE_2__.log.success(msg);
            _MsgBox__WEBPACK_IMPORTED_MODULE_3__.msgBox.success(msg);
        }
    ...
    async getFanCardData(createId) {
        ...
        try {
            supportInfo = await _API__WEBPACK_IMPORTED_MODULE_0__.API.getSupportingPlanForOneCreator(createId);
        }
        catch (error) {
            this.errorCount++;
    ...
    bindEvents() {
        ...
        for (const item of this.tips) {
            if (item.wrap) {
                ...
                btn.addEventListener('click', () => {
                    (0,_setting_Settings__WEBPACK_IMPORTED_MODULE_3__.setSetting)(item.settingName, false);
                });
            }
        }
        // 选择背景图片
        ...
        // 查看每天下载的文件大小的历史数据
        {
            ...
            totalDownloadHistory.addEventListener('click', () => {
                _EVT__WEBPACK_IMPORTED_MODULE_0__.EVT.fire('totalDownloadHistory');
            });
        }
        // 显示不下载重复文件的提示
    ...
    saveRadio(name) {
        ...
        for (const radio of radios) {
            radio.addEventListener('click', () => {
                (0,_Settings__WEBPACK_IMPORTED_MODULE_1__.setSetting)(name, radio.value);
            });
        }
    }
    // 恢复值为 Boolean 的设置项
...
class NameRuleManager {
    ...
    setInputValue() {
        ...
        if (rule !== _Settings__WEBPACK_IMPORTED_MODULE_3__.settings.userSetName) {
            (0,_Settings__WEBPACK_IMPORTED_MODULE_3__.setSetting)('userSetName', rule);
        }
    }
    // 处理用命名规则的非法字符和非法规则
...
class SaveNamingRule {
    ...
    add(rule) {
        ...
        if (!_Settings__WEBPACK_IMPORTED_MODULE_3__.settings.namingRuleList.includes(rule)) {
            ...
            list.push(rule);
            (0,_Settings__WEBPACK_IMPORTED_MODULE_3__.setSetting)('namingRuleList', list);
        }
